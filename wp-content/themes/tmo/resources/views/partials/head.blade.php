<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="{{ get_stylesheet_directory_uri() }}/favicon/apple-touch-icon.png">
  ...
  <link rel="shortcut icon" href="{{ get_stylesheet_directory_uri() }}/favicon/favicon.ico">
  <meta name="msapplication-TileColor" content="#233a78">
  <meta name="msapplication-config" content="{{ get_stylesheet_directory_uri() }}/favicon/browserconfig.xml">
